...
export default function DeleteBanner({ onClose, onDelete }) {
  return (
    <div
    ...
    >
      <div className={styles.modal}>
        ...
        <div className={styles.text}>
          <p>
            Are you sure you want to permanently delete this Youtube video? This
            video will no longer be visible to users.
          </p>
        </div>
